...
pub trait IWallet<ContractState> {
    fn withdraw(ref self: ContractState, token: ContractAddress, recipient_address: ContractAddress, amount: u256) -> bool;
    fn check_balance(self: @ContractState, token: ContractAddress, address: ContractAddress) -> u256;
